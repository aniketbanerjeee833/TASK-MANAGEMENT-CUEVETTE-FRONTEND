...
export const getAllMyTasks = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get("http://localhost:5000/api/v1/task/allMyTasks", {
      headers: {
...
export const getAnalyticsTask = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get("http://localhost:5000/api/v1/task/analyticsTask", {
      headers: {
        Authorization: `Bearer ${token}`
      }
    });
...
export const updateCheckListStatus = () => async (dispatch) => {
  ...
  dispatch(taskSlice.actions.getAllTasksRequest());
  try {
    const response = await axios.put(`http://localhost:5000/api/v1/task/allMyTasks${taskId}/${checkListId}`, {
      headers: {
        Authorization: `Bearer ${token}`
      }
    });
...
export const updateDueDate = () => async (dispatch) => {
  ...
  console.log(token)
  try {
    const response = await axios.patch("http://localhost:5000/api/v1/task/updateDueDate", {}, {
      headers: {
        Authorization: `Bearer ${token}`
      }
    });
...
export const updateTaskStatus = (taskId,status) => async (dispatch) => {
  ...
  try {
    const response = await axios.patch(`http://localhost:5000/api/v1/task/updateTask/${taskId}`, {status}, {
      headers: {
        Authorization: `Bearer ${token}`
      }
    });
...
export const getAllMyTasksForThisMonth = (month,year) => async (dispatch) => {
  ...
  dispatch(taskSlice.actions.getAllTasksRequest());
  try {
    const response = await axios.get(`http://localhost:5000/api/v1/task/allMyTasksThisMonth/${month}/${year}`,{
      headers: {
        Authorization: `Bearer ${token}`
      }
    });
...
export const deleteMyTasks = (taskId) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(`http://localhost:5000/api/v1/task/deletetask/${taskId}`, {
      headers: {
        Authorization: `Bearer ${token}`
      }
    });
